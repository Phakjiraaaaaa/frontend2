  ...
  const tourServices = [
    {
      ...
      description:
        "สัมผัสเสน่ห์ของเมืองเก่าและประวัติศาสตร์อันยาวนาน ชมสถาปัตยกรรมโบราณ พร้อมเรียนรู้วัฒนธรรมท้องถิ่น",
    ...
    },
    {
      ...
      description:
        "ผจญภัยไปกับเส้นทางธรรมชาติอันงดงาม ล่องแก่ง เดินป่า และกิจกรรมกลางแจ้งที่น่าตื่นเต้น",
    ...
    },
    {
      ...
      description:
        "พักผ่อนบนชายหาดสวยและเกาะที่มีน้ำทะเลใสสะอาด ดำน้ำชมปะการังและสัตว์ทะเลหลากสี",
    ...
    },
    {
      ...
      description:
        "สัมผัสวัฒนธรรมการกินของไทยผ่านอาหารท้องถิ่นรสเลิศ เรียนรู้การทำอาหารไทย และเยี่ยมชมตลาดท้องถิ่น",
    ...
    },
    {
      ...
      description:
        "สัมผัสความสดชื่นของธรรมชาติบนภูเขา ชมวิวทิวทัศน์อันงดงาม และแช่น้ำตกใสเย็น",
    ...
    },
    {
      ...
      description:
        "เรียนรู้วิถีชีวิตของชุมชนท้องถิ่น ร่วมทำกิจกรรมกับชาวบ้าน และสัมผัสความเป็นอยู่แบบดั้งเดิม",
    ...
    <div className="container my-5">
      ...
      <div className="text-center mb-5">
        ...
        <p className="lead mb-4">
          ค้นพบประสบการณ์ท่องเที่ยวที่หลากหลายและน่าประทับใจกับเรา
        </p>
          ...
          >
            <div className="row align-items-center">
              <div className="col-lg-8">
                ...
                <p className="mb-4">
                  จองทัวร์วันนี้รับส่วนลดทันที 15% สำหรับการเดินทางในเดือนหน้า
                  พร้อมของสมนาคุณพิเศษ
                </p>
      ...
      <div className="row mt-5">
        <div className="col-12 text-center mb-4">
          <h3 className="mb-3" style={{ color: "#7ec4cf" }}>
            เสียงจากลูกค้า
          </h3>
        ...
        <div className="col-md-4 mb-4">
          <div className="card border-0 shadow-sm h-100 p-4 rounded-4">
            ...
            <p className="card-text fst-italic">
              "ประทับใจมากกับทัวร์เมืองเก่า ไกด์มีความรู้และเป็นกันเอง
              ได้เรียนรู้ประวัติศาสตร์มากมาย อาหารอร่อย สถานที่สวยงาม
              แนะนำเลยครับ"
            </p>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card border-0 shadow-sm h-100 p-4 rounded-4">
            ...
            <p className="card-text fst-italic">
              "ทัวร์เกาะและชายหาดสุดประทับใจ น้ำทะเลใสมาก ปะการังสวยงาม
              ที่พักสะดวกสบาย การดูแลเอาใจใส่ดีเยี่ยม
              จะกลับมาใช้บริการอีกแน่นอนค่ะ"
            </p>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card border-0 shadow-sm h-100 p-4 rounded-4">
            ...
            <p className="card-text fst-italic">
              "ทัวร์ผจญภัยสุดมันส์! กิจกรรมล่องแก่งตื่นเต้นมาก
              แคมป์กลางป่าก็สะดวกเกินคาด อาหารอร่อย ไกด์ดูแลความปลอดภัยดีมาก
              ประทับใจสุดๆ"
            </p>
          </div>
        </div>
      ...
      <div className="row mt-4">
        <div className="col-12 text-center">
          ...
          >
            ...
            <p className="mb-4">
              ติดต่อเราเพื่อสอบถามข้อมูลเพิ่มเติมหรือจองทัวร์ได้ตามช่องทางด้านล่าง
            </p>
